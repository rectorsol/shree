                                        ...
                                        <tr class="gradeU" id="tr_<?php echo $value['id']?>">
                                         ...
                                         <td><?php echo $value['challan_no'];?></td>
                                          ...
                                          <td>
                                            ...
                                            <a class="text-center tip" target="_blank" href="<?php echo base_url('admin/frc/return_print/').$value['id'] ?>">
                                      ...
                                      <td><input type="checkbox" class="sub_chk" data-id="1"></td>
                                         ...
                                         <td>challan_no</td>
                                          ...
                                          <td>
                                            ...
                                            <a href="<?php echo base_url('admin/Orders/edit_order_product_details/') ?> ">
                                              <i class="fas fa-edit"></i>
                                            </a>
                                            <a class="text-danger text-center tip" href="javascript:void(0)" onclick="delete_detail()" data-original-title="Delete">
                                              <i class="mdi mdi-delete red"></i>
                                            </a>
                                            <a class="text-center tip" target="_blank" href="<?php echo base_url('admin/frc/return_print/3')?>">
                                              <i class="fa fa-print" aria-hidden="true"></i></a>
                                          </td>
                                        </tr>
                                </tbody>
