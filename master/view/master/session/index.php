    ...
    <div class="card-body">
      ...
      <div class="card">
        ...
        <div class="widget-content nopadding">
          <table class="table table-striped table-bordered data-table" id="session">
              <thead>
                <tr>
              ...
              <tbody>
                ...
                <div id="<?php echo $value->id; ?>" class="modal hide" >
                  ...
                  <form class="form-horizontal" method="post" action="<?php echo base_url('admin/Session_year/edit/').$value->id ?>" name="basic_validate" id="basic_validate" novalidate="novalidate">
                    ...
                    <div class="modal-body">
                      <div class="widget-content nopadding">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input type="text" class="form-control" name="financial_year" value="<?php echo $value->financial_year; ?>" id="required">
                          </div>
                        </div>
                        </div>
                      </div>
...
<div id="addnew" class="modal hide">
    <div class="modal-dialog" role="document ">
    <div class="modal-content">
  <form class="form-horizontal" method="post" action="<?php echo base_url('admin/session_year/addSession')?>" name="basic_validate" id="basic_validate" novalidate="novalidate">
    <div class="modal-header">
    ...
    <div class="modal-body">
      <div class="widget-content nopadding">
        <div class="form-group row">
          <label class="control-label col-sm-3">Financial Year</label>
          <div class="col-sm-9">
            <input type="text" class="form-control" name="financial_year" value="" id="required">
          </div>
        </div>
        </div>
      </div>
...
<script>
  function delete_detail(id)
  {
    ...
    if (del== true)
    {
      ...
      if (sureDel == true)
      {
        window.location="<?php echo base_url()?>admin/Session/delete/"+id;
      }
    }
  }
</script>
