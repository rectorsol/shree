...
class FDA_model extends CI_Model {
 ...
 {
   $this->db->select('fda_table.id AS id, fda_table.asign_date, fda_table.fabric_name AS fabric_name, fda_table.fabric_type, design.designName, design.designSeries, design.designCode,design.stitch');
   $this->db->from('fda_table');
