<div class="row">
  <div class="col-md-12">
    <div class="card">
      <div class="card-body">
        <form method="post" action="<?php echo base_url('admin/Dye_transaction/addIssue')?>">
               ...
               <table id="fresh_form" class="remove_datatable">
                ...
                <tbody id="fresh_data">
                  <tr id="0">
                    ...
                    <td><input type="text" name="fabric_name[]" class="form-control fabric_name " id='fabric0' readonly>
                           </td>
