          ...
          <div class="form-row">
            <div class="col-4">
              <select id="searchByCat" name="searchByCat"  class="form-control">
                ...
                <option value="unitName">Cause Name</option>
          ...
          <table class="table table-striped table-bordered data-table" id="unit">
            ...
            <tbody>
              ...
              <div id="<?php echo $value->id; ?>" class="modal hide" >
                ...
                <form class="form-horizontal" method="post" action="<?php echo base_url('admin/Cause/edit/').$value->id;?>" name="basic_validate" id="basic_validate" novalidate="novalidate">
                  ...
                  <div class="modal-body">
                    <div class="widget-content nopadding">
                      <div class="form-group row">
                        <label class="control-label col-sm-3">Cause Name</label>
                        <div class="col-sm-9">
                          <input type="text" class="form-control" name="name" value="<?php echo $value->name; ?>" id="required">
                        </div>
                      </div>
...
<div id="addnew" class="modal hide">
     <div class="modal-dialog" role="document ">
     <div class="modal-content">
  <form class="form-horizontal" method="post" action="<?php echo base_url('admin/Cause/add')?>" name="basic_validate" id="basic_validate" novalidate="novalidate">
    <div class="modal-header">
    ...
    <div class="modal-body">
      <div class="widget-content nopadding">
        <div class="form-group row">
          <label class="control-label col-sm-3">Cause Name</label>
          <div class="col-sm-9">
            <input type="text" class="form-control" name="name" value="" id="required">
          </div>
        </div>
...
<script>
    function delete_detail(id)
    {
      ...
      if (del== true)
      {
        ...
        if (sureDel == true)
        {
          window.location="<?php echo base_url()?>admin/Cause/delete/"+id;
        }
