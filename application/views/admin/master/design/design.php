    ...
    <div id="addnew" class="modal hide">
      <div class="modal-dialog" role="document ">
        <div class="modal-content">
          ...
          <form class="form-horizontal" id="addDesign" method="post"
            action="<?php echo base_url('admin/Design/addDesign') ?>" name="basic_validate"
                  ...
                  <div class="modal-body">
                    <form action="<?php echo base_url('/admin/Design/filter1'); ?>" method="post">
                      <div class="form-row">
                        ...
                        <input type="hidden" name="type" value="design"><input type="hidden" name="search"
                          value="simple">
                ...
                if($design_data>0)
                    ...
                    <tr class="gradeU" id="<?php echo $value->id?>">
                      ...
                      <td>
                        <div class="actions">
                          <a class="btn default btn-outline image-popup-vertical-fit el-link"
                            href="<?php echo base_url('/upload/')?><?php echo $value->designPic; ?>"> <img
                              src="<?php echo base_url('/upload/')?><?php echo $value->designPic; ?>" alt="image"
                      ...
                      <td>
                        ...
                        <a class="text-center tip" target="_blank"
                          href="<?php echo base_url('admin/design/design_print/').$value->id ?>">
