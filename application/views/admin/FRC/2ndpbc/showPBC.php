                            ...
                            <tr>
                              ...
                              <td>
                                <input type="text" name="unit" class="form-control form-control-sm" value=""
                                  placeholder="Unit"></td>
                              <td>
                                <input type="text" name="tc" class="form-control form-control-sm" value=""
                                  placeholder="TC"></td>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="widget-box">
                      <div class="row well" >
                            <div class="col-6"> 
                  <a type="button" class="btn btn-info   btn-success"  href='<?php echo base_url('/admin/FRC/Show_PBC'); ?>'
