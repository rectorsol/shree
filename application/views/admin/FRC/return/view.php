                ...
                <div class="card-body">
                    ...
                    <div class="widget-box">
                        <div class="widget-content nopadding">
                           <div class="col-6"><a type="button" class="btn btn-info pull-left print_all btn-success"
   ...
   if(allVals.length <=0)
   {
     ...
     $.each(ids, function(index, value){
       ...
       $.ajax({
         ...
         cache:false,
         data: {'ids' : data,'title':'Challan Return Detail','type':'return', '<?php echo $this->security->get_csrf_token_name(); ?>' : '<?php  echo $this->security->get_csrf_hash(); ?>'},
