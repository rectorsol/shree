                ...
                <tbody>
                 <?php
                                        ...
                                        foreach ($frc_data as $value) { 
                                          ...
                                          $t+=$value['total_value'];
                                          ?>
                                        <tr class="<?php if($value['parent']=='') {echo ' text-primary';} ?>"  id="tr_<?php echo $value['fsr_id']?>">

                                          <td><input type="checkbox" class="sub_chk hover" data-id="<?php echo $value['fsr_id'] ?>"></td>
                                         ...
                                         <td><?php echo $value['purchase_rate'];?></td>
                                          ...
                                          <td ><a class="text-center tip hover" target="_blank" href="<?php echo base_url('admin/FRC/return_print/').$value['fsr_id']?>">
